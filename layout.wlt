...
MonoBehaviour:
  ...
  m_MinSize: {x: 0, y: 0}
  m_MaxSize: {x: 0, y: 0}
  m_LastLoadedLayoutName: AllInOne
--- !u!114 &8
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
...
MonoBehaviour:
  ...
  m_LastProjectPath: D:\Projets\Courses\Celian\TP1-Creation3D-v3
  m_LockTracker:
    m_IsLocked: 0
  m_FolderTreeState:
    scrollPos: {x: 0, y: 0}
    m_SelectedIDs: 0e680000
    m_LastClickedID: 26638
    m_ExpandedIDs: 000000000e68000000ca9a3b
    m_RenameOverlay:
  ...
  m_AssetTreeState:
    ...
    m_CreateAssetUtility:
      ...
      m_ResourceFile: 
  m_ListAreaState:
    m_SelectedInstanceIDs: e2610000
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      scrollPos: {x: 0, y: 0}
      m_SelectedIDs: e2610000
      m_LastClickedID: 0
      m_ExpandedIDs: aaf1ffff3afbffff
      m_RenameOverlay:
        m_UserAcceptedRename: 0
        m_Name: 
        m_OriginalName: 
...
MonoBehaviour:
  ...
  m_AudioPlay: 0
  m_Position:
    m_Target: {x: 423.27365, y: 817.7206, z: 1342.6696}
    speed: 2
    m_Value: {x: -10.284402, y: 21.698595, z: -1.0154116}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: -0.06070655, y: -0.9324266, z: 0.18648739, w: -0.30352607}
    speed: 2
